    ...
    def model_evaluation(self, models, X_test, y_test):
        try:
            ...
            for i in list_of_models:
                ...
                if ((accuracy > self.accuracy and F1_score > self.F1_score) or 
                    (accuracy > self.accuracy and roc_score > self.roc_score) or 
                    (roc_score > self.roc_score and F1_score > self.F1_score)):
    ...
    def model_pickling(self, best_model):
        try:
            ...
            with open(self.pickle_file_path, "wb") as file_obj:
                joblib.dump(model_evaluation, file_obj)
